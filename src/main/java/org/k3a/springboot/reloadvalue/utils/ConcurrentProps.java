...
/**
 * The <code>ConcurrentProps</code> class represents a persistent set of
 * properties. The <code>ConcurrentProps</code> can be saved to a stream
 ...
 * <p>
 * Because <code>ConcurrentProps</code> inherits from <code>Hashtable</code>, the
 * <code>put</code> and <code>putAll</code> methods can be applied to a
 * <code>ConcurrentProps</code> object.  Their use is strongly discouraged as they
 * allow the caller to insert entries whose keys or values are not
 * <code>Strings</code>.  The <code>setProperty</code> method should be used
 * instead.  If the <code>store</code> or <code>save</code> method is called
 * on a "compromised" <code>ConcurrentProps</code> object that contains a
 ...
 * will fail if it is called on a "compromised" <code>ConcurrentProps</code>
 ...
 * <tt>ConcurrentProps</tt> object without the need for external synchronization.
 *
...
/**
 * why bother writing this class instead of using {@link java.util.Properties}?
 * because Properties is bad at concurrency ,
 * so i decide to rewrite Properties(basically just replace the Hashtable with ConcurrentHashMap)
 */
public
class ConcurrentProps extends ConcurrentHashMap<Object,Object> {
    /**
     ...
     * @serial
     */
    protected ConcurrentProps defaults;

    /**
     * Creates an empty property list with no default values.
     */
    public ConcurrentProps() {
	this(null);
    }
     ...
     */
    public ConcurrentProps(ConcurrentProps defaults) {
     ...
     * <p>
     * ConcurrentProps are processed in terms of lines. There are two
     ...
     * @exception  ClassCastException  if this <code>ConcurrentProps</code> object
     ...
     * <code>ConcurrentProps</code> table to the output character stream in a
     * format suitable for using the {@link #load(java.io.Reader) load(Reader)}
     * method.
     * <p>
     * ConcurrentProps from the defaults table of this <code>ConcurrentProps</code>
     ...
     * <p>
     * Then every entry in this <code>ConcurrentProps</code> table is
    ...
    /**
     * Writes this property list (key and element pairs) in this
     * <code>ConcurrentProps</code> table to the output stream in a format suitable
     * for loading into a <code>ConcurrentProps</code> table using the
     ...
     * @throws ClassCastException  if this <code>ConcurrentProps</code> object
     *         contains any keys or values that are not 
     *         <code>Strings</code>.
     ...
     * including distinct keys in the default property list if a key
     * of the same name has not already been found from the main
     * properties list.  ConcurrentProps whose key or value is not
     * of type <tt>String</tt> are omitted.
     * <p>
     * The returned set is not backed by the <tt>ConcurrentProps</tt> object.
     * Changes to this <tt>ConcurrentProps</tt> are not reflected in the set,
     * or vice versa.
     *
